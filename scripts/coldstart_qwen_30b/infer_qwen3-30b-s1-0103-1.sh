...
PROJECT_DIR="."
BASE_MODEL_PATH="/mnt/llm-train/users/explore-train/zhangyuqi60/Nomerge/ms-swift/hf_outputs/qwen3-30b-s1-0103-1"
...
OUTPUT_DIR="${PROJECT_DIR}/outputs/coldstart/qwen3-30b-s1-0103-1"
